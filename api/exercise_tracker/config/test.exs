...
config :exercise_tracker, ExerciseTrackerWeb.Endpoint,
  ...
  secret_key_base: "HoKL419V8qpUpm0kEqxATrIz4raZjcQqOXGSeQ/RwQ79d0/Yj6PhD8e+sEXfXOoA",
  server: false

# In test we don't send emails.
config :exercise_tracker, ExerciseTracker.Mailer, adapter: Swoosh.Adapters.Test
